...
main_path = r'D:/!Joe/Crpto/history_candle_data_test'
下载线程数 = 16
debug_mode = False  # 调试模式，开启后仅下载前五个交易对，用于调试
...
stop_profit_list = [0.02, 0.05, 0.08, 0.1, 0.12, 0.15, 0.3, 100]
stop_loss_list = [-0.02, -0.05, -0.08, -0.1, -0.12, -0.15, -0.3, -1]
